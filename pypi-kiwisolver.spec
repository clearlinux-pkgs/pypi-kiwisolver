...
Source0  : https://files.pythonhosted.org/packages/85/30/28df42dda1abe08eb2ff70a76c4dc04ffc9a0200a7c244300da436709a37/kiwisolver-1.4.3.tar.gz
...
%prep
%setup -q -n kiwisolver-1.4.3
cd %{_builddir}/kiwisolver-1.4.3
pushd ..
cp -a kiwisolver-1.4.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656442615
...
cp %{_builddir}/kiwisolver-1.4.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-kiwisolver/ace4126f107c97f428124e67a02779b336f58099
